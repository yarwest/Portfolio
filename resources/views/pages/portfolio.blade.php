    ...
    <div class="container" style="margin-top:50px;">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <p>These are (almost) all of the projects that I have worked or are still working on, either by myself or with a team. A number of these projects are open source on Github, head over to my <a href="http://github.com/yarwest">Github profile</a> where you can find a good amount of them.<br>If you want to know more about a certain project or take a look at the code, feel free to reach out to me via the <a href="/contact">contact page</a>.<br>(You can click on an image to enlargen it)</p>
